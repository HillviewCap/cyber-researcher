...
class CyberStormConfig:
    ...
    def _load_secrets(self):
        ...
        env_vars = [
            "OPENAI_API_KEY", "OPENAI_API_TYPE", "AZURE_API_BASE", "AZURE_API_VERSION",
            "BING_SEARCH_API_KEY", "YOU_API_KEY", "SERPER_API_KEY", "BRAVE_API_KEY",
    ...
    def _setup_default_configs(self):
        ...
        if self.secrets.get("OPENAI_API_TYPE") == "azure":
            openai_kwargs.update({
                "api_base": self.secrets.get("AZURE_API_BASE"),
                "api_version": self.secrets.get("AZURE_API_VERSION")
            })
        
        # Agent configurations
        self.security_analyst_config = AgentConfig(
            lm_config=LMConfig(
                model_name=self.secrets.get("DEFAULT_GENERATION_MODEL", "gpt-4"),
                max_tokens=1000,
                **openai_kwargs
            ),
    ...
    def get_lm_for_agent(self, agent_type: str) -> LitellmModel:
        """

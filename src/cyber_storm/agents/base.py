...
from knowledge_storm.lm import LanguageModel
from knowledge_storm.rm import RetrievalModule
...
class BaseCyberAgent(ABC):
    ...
    def retrieve_information(self, query: str, max_results: int = 5) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            return [{"content": r.raw_utterance, "url": r.url, "title": getattr(r, 'title', '')} 
                   for r in results]
